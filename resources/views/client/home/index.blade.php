        ...
        <section id="portfolio" class="portfolio">
            <div class="container" data-aos="fade-up">
                ...
                <ul id="portfolio-flters" class="d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <li data-filter=".filter-app">Đang hoạt động</li>
                    <li data-filter=".filter-card">bảo trì</li>
                    <li data-filter=".filter-web">Web</li>
                </ul>

                {{-- <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                  <div class="col-lg-4 col-md-6 portfolio-item filter-app" style="position: absolute; left: 0px; top: 0px;">
                    <div class="portfolio-img"><img src="http://127.0.0.1:8000/storage/images/football_pitches/sb1.jpg" class="img-fluid" alt=""></div>
                            ...
                            <div class="portfolio-img">
                                @if ($item->images->count() != 0)
                                    <img src="{{ config('app.image') . $item->images[0]->image }}" class="img-fluid"
                                        alt="">
                                @else
                                    <img src="{{ config('app.image') . 'images/football_pitches/default_football_pitch.png' }}" class="img-fluid"
                                        alt="">
                                @endif
                            </div>
                            <div class="portfolio-info">
                    ...
                    {{-- <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-img"><img src="http://127.0.0.1:8000/storage/images/football_pitches/sb1.jpg" class="img-fluid"
                                alt=""></div>
                        <div class="portfolio-info">
                            <h4>App 1</h4>
                            <p>App</p>
